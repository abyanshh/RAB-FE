...
export default function DoctorConsult2({ doctors, openBookingDialog, token }) {
        ...
        >
          <div className="flex flex-col h-full">
            <div className="p-4 flex gap-4 h-full">
              <img
                src={doctor.avatar_urls || "/image/image.png"}
            ...
            <div className="px-4 pb-4 flex-grow">
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-wrap gap-1 mb-2">
                  {doctor.available_days.map((avail, index) => (
                    <span
                      key={index}
